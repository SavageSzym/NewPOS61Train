...
//******************************************************************************
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #992033;}'  +
            '/* Drag Handle */'                                         +
            'td.scwDrag                 {background-color:  #9999CC;'   +
                                        'color:             #CCCCFF;}'  +
            '/* Week number heading */'                                 +
            'td.scwWeekNumberHead       {color:             #992033;}'  +
            '/* Week day headings */'                                   +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #992033;'   +
                                        'color:             #FFFFFF;}'  +
            ...
            'td.scwCellsExMonthDisabled {background-color:  #999999;'   +
                                        'color:             #666666;}'  +
            'td.scwFootDisabled         {background-color:  #992033;'   +
                                        'color:             #FFFFFF;}'  +
        '</style>'
                    );
                 ...
                 if (scwExpValYear.exec(scwArrSeed[0])  == null ||
                     ...
                     scwExpValDay.exec(scwArrSeed[2])   == null) {
	                     if (scwShowInvalidDateMsg) {
		                     /*
		                    // KFG - DO NOT VALIDATE THE TYPED DATE.
